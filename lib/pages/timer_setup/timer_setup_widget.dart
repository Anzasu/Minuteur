...
class TimerSetupWidget extends StatefulWidget {
  const TimerSetupWidget({super.key});

  static String routeName = 'TimerSetup';
  static String routePath = '/timerSetup';
...
class _TimerSetupWidgetState extends State<TimerSetupWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimerSetupModel());
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.heuresTextController,
                                  focusNode: _model.heuresFocusNode,
                                  autofocus: false,
                                  obscureText: false,
